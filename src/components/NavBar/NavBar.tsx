...
const NavLinkWrapper = styled.a<{$bgColor: 'blue' | 'pink' | 'purple' | 'yellow'}>`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    ${(props) => css`background: ${NavLinkBGColor(props.$bgColor)};`}  
    color: ${COLOR.Dark_Purple};
    font-size: 2rem;
    font-weight: bold;
    ...
    return (
        ...
        <Nav>
            ...
            <NavWrapper $hidden={isMenuHidden}>
                <li><NavLink $bgColor='pink' href='/'>Home</NavLink></li>
                <li><NavLink $bgColor='blue' href='/about'>About</NavLink></li>
                <li><NavLink $bgColor='purple' href='/blog'>Blog</NavLink></li>
                {/* TODO: Link to Resume */}
                <li><NavLink $bgColor='yellow' href='/about'>Resume</NavLink></li>
                <li><NavLink $bgColor='pink' href='https://github.com/hieronymus-jodi'>GitHub</NavLink></li>
            </NavWrapper>
        </Nav>
        </>
    );
